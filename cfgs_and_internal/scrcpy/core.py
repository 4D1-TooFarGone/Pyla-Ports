...
class Client:
    ...
    def __init_server_connection(self) -> None:
        ...
        # TCP_NODELAY only applies to TCP sockets. On Android the bot talks to the scrcpy
        # server over a direct AF_UNIX (abstract) socket, where this option is invalid —
        # so ignore failures instead of crashing.
        try:
