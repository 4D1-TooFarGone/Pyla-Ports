...
class Play:
    ...
    def __init__(self, main_info_model, tile_detector_model, close_tile_detector_model, window_controller, pyla_code, input_size=(640, 640)):
        ...
        self.Detect_main_info = Detect(main_info_model, classes=['enemy', 'teammate', 'player'], input_size=input_size)
